...
This is a divide now - we have software engineers outwardly rejecting AI or merely consuming via Claude Code/Cursor to accelerate the lego brick building process... but software development is dead - I killed it. Software can now be developed cheaper than the wage of a burger flipper at maccas and it can be built autonomously whilst you are AFK.
...
> "something incredible just happened here perhaps first evolutionary software auto heal. i was running the system under a ralph system loop test. it"
